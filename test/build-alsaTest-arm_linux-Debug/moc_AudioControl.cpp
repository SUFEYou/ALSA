...
static const char qt_meta_stringdata_AudioControl[] = {
    "AudioControl\0\0test()\0"
};

const QMetaObject AudioControl::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_AudioControl,
      qt_meta_data_AudioControl, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &AudioControl::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_AudioControl))
